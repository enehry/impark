<template>
    <table-layout
        title="User activity logs/Warehouse"
        note="You can filter the logs by changing the start date to end date, selected starting date and empty end date means start date and the date onwards."
    >
        <Head title="Users activity logs" />
        <div class="py-4">
            <div

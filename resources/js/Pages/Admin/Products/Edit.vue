<template>
    <table-layout title="Edit Product" backRoute="products.index">
                ...
                >
                    ...
                    <div class="w-full">
                        ...
                        <JetInput
                            ...
                            type="number"
                            class="w-full px-4 py-2 rounded-2xl text-gray-400 bg-gray-100 border-2 border-gray-300 dark:border-gray-700"
                            placeholder="Price"
                            required
                        ></JetInput>
                        <JetInputError
    ...
    data() {
        return {
            ...
            form: useForm({
                ...
                reordering_point: this.product.reordering_point + "",
                maximum_shelf_life: this.product.maximum_shelf_life + "",

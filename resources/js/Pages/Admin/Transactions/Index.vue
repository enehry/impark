<template>
    <table-layout
        title="Transactions"
        note="You can change the range of received date, select specific branch and specific products."
    >
                ...
                >
                    ...
                    <div class="flex gap-2 sm:w-auto w-full">
                        ...
                        >
                            ...
                            <option
                                v-for="branch in transaction_branches"
                                :key="branch.id"
                                :value="branch.id"
                            >
                                {{ branch.name }}
...
import TableRowTransaction from "./TableRowTransaction.vue";
    ...
    data() {
        return {
            ...
            transaction_params: {
                ...
                branch_id: this.transaction_filter.branch_id,

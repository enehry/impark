  ...
  public function registerEvents(): array
  {
    return [
      ...
      AfterSheet::class => function (AfterSheet $event) {
        ...
        $event->sheet->setCellValue('A2', 'BRANCH: ' . Auth::user()->branch->name . ' STOCK REPORT');
        $event->sheet->setCellValue(sprintf('A%d', $last_row), 'BRANCH: ' . Auth::user()->branch->name . ' STOCK REPORT');

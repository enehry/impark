...
class ReceivedProductsExport implements
  FromCollection,
  WithHeadings,
  WithMapping,
  WithStyles,
  ...
  public function registerEvents(): array
  {
    return [
      ...
      AfterSheet::class => function (AfterSheet $event) {
        ...
        $header = $this->start_date ? ' RECEIVED PRODUCTS REPORT OF ' . $branch . ' FROM ' . $this->start_date . ' TO ' . $this->end_date :
          ' RECEIVED PRODUCTS OF ' . $branch;
